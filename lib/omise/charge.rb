...
module Omise
  ...
  class Charge < OmiseObject
    ...
    # value of the `paid` attribute if it's present, `captured` otherwise.
    #
    # Returns a boolean.
    #
    def paid
    ...
    # Tells wether or not the charge was paid. This method will return the
    # value of the `captured` attribute if it's present, `paid` otherwise.
    #
    # Returns a boolean.
    #
    ...
    #   the `paid` attribute. You can safely use `paid` instead since it will
    #   fallback to `captured` automatically.
    #
    def captured
